...
function check(){
	if(form_info.username.value==""){
			...
			alert("请输入邮箱");
			return false;
		}else if(form_info.question.value==""){
			alert("请输入密保问题");
			return false;
		}else if(form_info.answer.value==""){
			alert("请输入密保答案");
			return false;
...
<body>
    <div class="rg_layout">
     ...
     <div class = "rg_center">
          ...
          <div class="rg_form">
         <form action="${pageContext.request.contextPath}/before/chkregister" method="post" id="form_info">
         <table>
         <tr>
         <td class="td_left">&nbsp;</td>
         ...
         <td class="td_right"><input type="text" name="username" id="username" placeholder="请输入用户名（不超过5位）"></td>
          ...
          <tr>
        	<td class="td_left"><label for="name"></label> 密保问题</td>
       		<td class="td_right"><input type="text" name="question" id="question" placeholder="用于找回密码（长度不能超过5）"></td>
           </tr>          
           <tr>
        	 <td class="td_left"><label for="tel"></label> 密保答案</td>
        	 <td class="td_right"><input type="text" name="answer" id="answer" placeholder="请输入答案（长度不能超过10）"></td>
           </tr>
           <tr>
